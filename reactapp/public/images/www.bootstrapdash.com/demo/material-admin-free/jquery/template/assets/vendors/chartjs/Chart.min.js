...
! function(t, e) {
    ...
    function R(t) {
        if (t) {
            ...
            for (r = 0; r < e.length; r++) e[r] = W(e[r], 0, 255);
            return i = i || 0 == i ? W(i, 0, 1) : 1, e[3] = i, e
        }
    }
    ...
    function z(t) {
        if (t) {
            ...
            if (e) {
                ...
                return [W(parseInt(e[1]), 0, 360), W(parseFloat(e[2]), 0, 100), W(parseFloat(e[3]), 0, 100), W(isNaN(i) ? 1 : i, 0, 1)]
            }
        }
    }
                ...
                if (!(isNaN(i) || i <= 0)) {
                    switch (t.beginPath(), e) {
                        ...
                        case "rectRounded":
                            ...
                            s = Math.cos(h + it) * u,
                            l = Math.sin(h + it) * u,
                            t.arc(n - s, a - l, d, h - J, h - et),
                            t.arc(n + l, a - s, d, h - et, h),
                            t.arc(n + s, a + l, d, h, h + et),
                            t.arc(n - l, a + s, d, h + et, h + J),
                            t.closePath();
                            break;
                        case "rect":
                                if (!r) {
    ...
    function St(t, e) {
        ...
        if (i) {
            var n = i.listeners,
                a = n.indexOf(e); - 1 !== a && n.splice(a, 1), n.length > 0 || (Mt.forEach(function(e) {
                delete t[e]
            }), delete t._chartjs)
        }
    }
    ...
    ct.extend(Ct.prototype, {
        ...
        _resolveDataElementOptions: function(t, e) {
            ...
            if (n = n || {}, ct.isArray(c))
                for (o = 0, s = c.length; o < s; ++o) f[l = c[o]] = wt([n[l], d[l], h[l]], g, e, p);
            else
                for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o) f[l = r[o]] = wt([n[l], d[c[l]], d[l], h[l]], g, e, p);
        ...
        _setDatasetHoverStyle: function() {
            var t, e, i, n, a, r, o = this.getMeta().dataset,
                s = {};
            if (o) {
    ...
    function Wt(t) {
        var e, i, n, a, r;
        return Vt(t) ? (r = t.width / 2, e = t.x - r, i = t.x + r, n = Math.min(t.y, t.base), a = Math.max(t.y, t.base)) : (r = t.height / 2, e = Math.min(t.x, t.base), i = Math.max(t.x, t.base), n = t.y - r, a = t.y + r), {
            left: e,
            top: n,
            right: i,
            bottom: a
    ...
    var Ut = xt.extend({
            ...
            inLabelRange: function(t, e) {
                var i = this._view;
                return Vt(i) ? qt(i, t, null) : qt(i, null, e)
            },
            inXRange: function(t) {
            ...
            getCenterPoint: function() {
                ...
                return Vt(i) ? (t = i.x, e = (i.y + i.base) / 2) : (t = (i.x + i.base) / 2, e = i.y), {
                    x: t,
                    y: e
                }
            },
    ...
    var te = Pt.extend({
            ...
            calculateBarValuePixels: function(t, e, i) {
                var n, a, r, o, s, l, u, d = this.chart,
                ...
                if (v || void 0 === v && void 0 !== b)
                    for (n = 0; n < _ && (a = g[n]).index !== t; ++n) a.stack === b && (r = void 0 === (u = h._parseValue(f[a.index].data[e])).start ? u.end : u.min >= 0 && u.max >= 0 ? u.max : u.min, (p.min < 0 && r < 0 || p.max >= 0 && r > 0) && (x += r));
    ...
    st._set("doughnut", {
        ...
        legendCallback: function(t) {
            var e, i, n, a = document.createElement("ul"),
                r = t.data,
                o = r.datasets,
                s = r.labels;
            if (a.setAttribute("class", t.id + "-legend"), o.length)
                for (e = 0, i = o[0].data.length; e < i; ++e)(n = a.appendChild(document.createElement("li"))).appendChild(document.createElement("span")).style.backgroundColor = o[0].backgroundColor[e], s[e] && n.appendChild(document.createTextNode(s[e]));
            return a.outerHTML
        },
        legend: {
            labels: {
    ...
    var fe = Pt.extend({
            ...
            updateBezierControlPoints: function() {
                ...
                if (o.spanGaps && (l = l.filter(function(t) {
                    ...
                    })), "monotone" === o.cubicInterpolationMode) ct.splineCurveMonotone(l);
                else
                    for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, n = ct.splineCurve(ct.previousItem(l, t)._model, i, ct.nextItem(l, t)._model, o.tension), i.controlPointPreviousX = n.previous.x, i.controlPointPreviousY = n.previous.y, i.controlPointNextX = n.next.x, i.controlPointNextY = n.next.y;
                if (a.options.elements.line.capBezierPoints)
                    for (t = 0, e = l.length; t < e; ++t) i = l[t]._model, ce(i, s) && (t > 0 && ce(l[t - 1]._model, s) && (i.controlPointPreviousX = u(i.controlPointPreviousX, s.left, s.right), i.controlPointPreviousY = u(i.controlPointPreviousY, s.top, s.bottom)), t < l.length - 1 && ce(l[t + 1]._model, s) && (i.controlPointNextX = u(i.controlPointNextX, s.left, s.right), i.controlPointNextY = u(i.controlPointNextY, s.top, s.bottom)))
            },
            draw: function() {
                var t, e = this.chart,
                    i = this.getMeta(),
    ...
    function _e(t, e) {
        ...
        for (n = 0, r = l.length; n < r; ++n)
            for (a = 0, o = (i = l[n].data).length; a < o; ++a)(s = i[a])._view.skip || e(s)
    }
    ...
    var Re = {
        ...
        update: function(t, e, i) {
            if (t) {
                ...
                }(l.concat(u), d), Le(l, h, d), Le(u, h, d) && Le(l, h, d),
                    function(t) {
                        var e = t.maxPadding;
    ...
    var ze, Ne = (ze = Object.freeze({
        ...
        Ve = "chartjs-render-monitor",
        We = "chartjs-render-animation",
        ...
        ! function(t, e) {
            var i = t[Be] || (t[Be] = {}),
                n = i.renderProxy = function(t) {
                    t.animationName === We && e()
                };
            ct.each(He, function(e) {
                Ye(t, e, n)
            }), i.reflow = !!t.offsetParent, t.classList.add(Ve)
        }(t, function() {
            if (s.resizer) {
                var e = t.parentNode;
    ...
    var hi = xt.extend({
            ...
            getCaretPosition: function(t, e, i) {
                var n, a, r, o, s, l, u = i.caretSize,
                    ...
                    p = e.width,
                    m = e.height;
                if ("center" === c) s = g + m / 2, "left" === h ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + p) + u, r = n, o = s - u, l = s + u);
                else if ("left" === h ? (n = (a = f + d + u) - u, r = a + u) : "right" === h ? (n = (a = f + p - d - u) - u, r = a + u) : (n = (a = i.caretX) - u, r = a + u), "top" === c) s = (o = g) - u, l = o;
                else {
                    s = (o = g + m) + u, l = o;
                    var v = r;
                    r = n, n = v
            ...
            drawBody: function(t, e, i) {
                var n, a, r, o, s, l, u, d, h = e.bodyFontSize,
                    c = e.bodySpacing,
                    f = e._bodyAlign,
                    g = e.body,
                    p = e.displayColors,
    ...
    ct.extend(_i.prototype, {
        ...
        buildOrUpdateControllers: function() {
            ...
            for (t = 0, e = a.length; t < e; t++) {
                ...
                if (o.type && o.type !== s && (i.destroyDatasetMeta(t), o = i.getDatasetMeta(t)), o.type = s, o.order = r.order || 0, o.index = t, o.controller) o.controller.updateIndex(t), o.controller.linkScales();
                else {
                    var l = xe[o.type];
    ...
    function Fi(t, e, i, n) {
        var a, r, o, s, l, u, d, h, c, f, g, p, m, v = i.length,
            b = [],
            x = [],
            y = [];
        for (a = 0; a < v; ++a) {
            if (s = i[a].label, l = i[a].major ? e.major : e.minor, t.font = u = l.string, d = n[u] = n[u] || {
                ...
                if (Pi(s))
                    for (r = 0, o = s.length; r < o; ++r) g = s[r], Ai(g) || Pi(g) || (c = ct.measureText(t, d.data, d.gc, c, g), f += h)
    ...
    var Ei = xt.extend({
        ...
        update: function(t, e, i) {
            ...
            if (l.beforeUpdate(), l.maxWidth = t, l.maxHeight = e, l.margins = ct.extend({
                ...
                for (o = [], n = 0, a = l.ticks.length; n < a; ++n) o.push({
                    value: l.ticks[n],
                    major: !1
                });
        ...
        _autoSkip: function(t) {
            var e, i, n, a, r = this.options.ticks,
                o = this._length,
        ...
        _computeGridLineItems: function(t) {
            var e, i, n, a, r, o, s, l, u, d, h, c, f, g, p, m, v, b = this,
                x = b.chart,
                y = b.options,
                _ = y.gridLines,
                k = y.position,
        ...
        _computeLabelItems: function() {
            var t, e, i, n, a, r, o, s, l, u, d, h, c = this,
                f = c.options,
                g = f.ticks,
                p = f.position,
                m = g.mirror,
        ...
        _drawLabels: function() {
            ...
            if (t.options.ticks.display) {
                var e, i, n, a, r, o, s, l, u = t.ctx,
                    d = t._labelItems || (t._labelItems = t._computeLabelItems());
                for (e = 0, n = d.length; e < n; ++e) {
                    if (o = (r = d[e]).font, u.save(), u.translate(r.x, r.y), u.rotate(r.rotation), u.font = o.string, u.fillStyle = o.color, u.textBaseline = "middle", u.textAlign = r.textAlign, s = r.label, l = r.textOffset, Pi(s))
                        for (i = 0, a = s.length; i < a; ++i) u.fillText("" + s[i], 0, l), l += o.lineHeight;
        ...
        _drawTitle: function() {
            var t = this,
                ...
                n = i.scaleLabel;
            if (n.display) {
                var a, r, o = Di(n.fontColor, st.global.defaultFontColor),
        ...
        Hi = Vi.extend({
            ...
            _configure: function() {
                var t = this,
                    e = t.options.offset,
                    i = t.ticks;
                Vi.prototype._configure.call(t), t.isHorizontal() || (t._reversePixels = !t._reversePixels), i && (t._startValue = t.minIndex - (e ? .5 : 0), t._valueRange = Math.max(i.length - (e ? 0 : 1), 1))
            },
            getPixelForValue: function(t, e, i) {
                var n, a, r, o = this;
                return Wi(e) || Wi(i) || (t = o.chart.data.datasets[i].data[e]), Wi(t) || (n = o.isHorizontal() ? t.x : t.y), (void 0 !== n || void 0 !== t && isNaN(e)) && (a = o._getLabels(), t = ct.valueOrDefault(n, t), e = -1 !== (r = a.indexOf(t)) ? r : e, isNaN(e) && (e = t)), o.getPixelForDecimal((e - o._startValue) / o._valueRange)
            },
            getPixelForTick: function(t) {
                var e = this.ticks;
    ...
    var Yi = Vi.extend({
            ...
            _configure: function() {
                var t, e = this,
                    ...
                    n = e.min,
                    a = e.max;
                Vi.prototype._configure.call(e), e.options.offset && i.length && (n -= t = (a - n) / Math.max(i.length - 1, 1) / 2, a += t), e._startValue = n, e._endValue = a, e._valueRange = a - n
            }
        }),
        Gi = {
            position: "left",
    ...
    var nn = Vi.extend({
                ...
                if (s.stacked || c) {
                    ...
                    for (t = 0; t < u.length; t++) {
                        ...
                        if (l.isDatasetVisible(t) && h(e))
                            for (void 0 === f[g] && (f[g] = []), a = 0, r = (n = u[t].data).length; a < r; a++) {
                                var p = f[g];
                    ...
                    for (t = 0; t < u.length; t++)
                        if (e = l.getDatasetMeta(t), l.isDatasetVisible(t) && h(e))
                            for (a = 0, r = (n = u[t].data).length; a < r; a++) i = o._parseValue(n[a]), isNaN(i.min) || isNaN(i.max) || e.data[a].hidden || i.min < 0 || i.max < 0 || (o.min = Math.min(i.min, o.min), o.max = Math.max(i.max, o.max), 0 !== i.min && (o.minNotZero = Math.min(i.min, o.minNotZero)));
            ...
            _configure: function() {
                var t = this,
                    e = t.min,
                    i = 0;
                Vi.prototype._configure.call(t), 0 === e && (e = t._getFirstTickValue(t.minNotZero), i = Ji(t.options.ticks.fontSize, st.global.defaultFontSize) / t._length), t._startValue = Qi(e), t._valueOffset = i, t._valueRange = (Qi(t.max) - Qi(e)) / (1 - i)
            },
            getPixelForValue: function(t) {
                var e = this,
                    i = 0;
    ...
    function In(t, e, i) {
        var n, a, r = [],
            o = {},
            s = e.length;
        for (n = 0; n < s; ++n) o[a = e[n]] = n, r.push({
            value: a,
            major: !1
        });
    ...
    var Fn = Vi.extend({
            ...
            update: function() {
                ...
                return vn("time scale", i.format, "time.format", "time.parser"), vn("time scale", i.min, "time.min", "ticks.min"), vn("time scale", i.max, "time.max", "ticks.max"), ct.mergeIf(i.displayFormats, n.formats()), Vi.prototype.update.apply(t, arguments)
            },
            getRightValue: function(t) {
            ...
            determineDataLimits: function() {
                ...
                for (t = 0, i = (l.data.datasets || []).length; t < i; ++t)
                    if (l.isDatasetVisible(t))
                        if (a = l.data.datasets[t].data, ct.isObject(a[0]))
                            for (p[t] = [], e = 0, n = a.length; e < n; ++e) r = Dn(s, a[e]), g.push(r), p[t][e] = r;
    ...
    function Hn(t, e, i, n, a) {
        ...
        if (n && a) {
            ...
            if (void 0 === i[0].angle)
                for (t.lineTo(i[a - 1].x, i[a - 1].y), r = a - 1; r > 0; --r) ct.canvas.lineTo(t, i[r], i[r - 1], !0);
            else
                for (o = i[0].cx, s = i[0].cy, l = Math.sqrt(Math.pow(i[0].x - o, 2) + Math.pow(i[0].y - s, 2)), r = a - 1; r > 0; --r) t.arc(o, s, l, i[r].angle, i[r - 1].angle, !0)
        }
    }
    ...
    function jn(t, e, i, n, a, r) {
        var o, s, l, u, d, h, c, f, g = e.length,
            ...
            b = 0,
            x = 0;
        for (t.beginPath(), o = 0, s = g; o < s; ++o) d = i(u = e[l = o % g]._view, l, n), h = Wn(u), c = Wn(d), r && void 0 === f && h && (s = g + (f = o + 1)), h && c ? (b = m.push(u), x = v.push(d)) : b && x && (p ? (h && m.push(u), c && v.push(d)) : (Hn(t, m, v, b, x), b = x = 0, m = [], v = []));
    ...
    var qn = {
            ...
            afterDatasetsUpdate: function(t, e) {
                ...
                for (n = 0; n < o; ++n)(r = l[n]) && (r.fill = En(l, n, s), r.boundary = Bn(r), r.mapper = Vn(r))
            },
            beforeDatasetsDraw: function(t) {
                var e, i, n, a, r, o, s, l = t._getSortedVisibleDatasetMetas(),
                    u = t.ctx;
    ...
    var Kn = xt.extend({
        ...
        draw: function() {
            var t = this,
                ...
                u = t.lineWidths;
            if (e.display) {
                var d, h = Un(e.rtl, t.left, t.minSize.width),
                    c = t.ctx,
                ...
                ct.each(t.legendItems, function(e, n) {
                    ...
                    }(w, k, e), v[n].left = h.leftForLtr(w, v[n].width), v[n].top = k,
                        function(t, e, i, n) {
                            var a = p / 2,
                                r = h.xPlus(t, m + a),
                                o = e + a;
    ...
    var Qn = xt.extend({
        ...
        draw: function() {
            var t = this,
                ...
                i = t.options;
            if (i.display) {
                var n, a, r, o = ct.options._parseFont(i),
                    s = o.lineHeight,
                    l = s / 2 + i.padding,
                    u = 0,
                    d = t.top,
    ...
    for (var ra in ea.filler = ia, ea.legend = na, ea.title = aa, ki.helpers = ct,
            function() {
                function t(t, e, i) {
                    var n;
                ...
                ct.where = function(t, e) {
                    ...
                    var o, s, l, u, d, h = 0,
                        c = i.length;
                    for (o = 0; o < c; o++)
                        if (null != (u = i[o]) && !0 !== ct.isArray(u)) h = ct.measureText(t, a, r, h, u);
                        else if (ct.isArray(u))
                        for (s = 0, l = u.length; s < l; s++) null == (d = u[s]) || ct.isArray(d) || (h = ct.measureText(t, a, r, h, d));
                    var f = r.length / 2;
                    if (f > i.length) {
            ...
            }(), ki._adapters = Si, ki.Animation = _t, ki.animationService = kt, ki.controllers = xe, ki.DatasetController = Pt, ki.defaults = st, ki.Element = xt, ki.elements = Yt, ki.Interaction = Ce, ki.layouts = Re, ki.platform = ti, ki.plugins = ei, ki.Scale = Vi, ki.scaleService = ii, ki.Ticks = Ci, ki.Tooltip = fi, ki.helpers.each(On, function(t, e) {
